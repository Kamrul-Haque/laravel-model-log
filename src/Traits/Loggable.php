...
namespace KamrulHaque\LaravelModelLog\Traits;

use KamrulHaque\LaravelModelLog\Models\Log;

/**
 * logs activity of the model trait belongs to,
 * data is stored in logs table through polymorphic
 * relationship between Log model and the model trait
 * belongs to
 *
...
{
    /**
     * calls createLog function of the trait itself on different model events
     *
     * @return void
     */
